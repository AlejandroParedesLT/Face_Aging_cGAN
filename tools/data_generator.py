...
class ImageDataGenerator:
    def __init__(self, batch_size, height, width, z_dim, shuffle=True,
        ...
        # Init params
        self.root_folder = 'D:/temporal_CV/1. AIPI 590 - Computer Vision/assignment/3. third_project/wiki_preprocess/wiki/'
        #self.root_folder = 'D:/temporal_CV/1. AIPI 590 - Computer Vision/assignment/3. third_project/wiki_preprocess/'
        if mode == 'train':
            self.file_folder = './data/preprocessed-wiki-lists/'
            #self.file_folder = './data/preprocessed-experiment-lists/'
        ...
        #self.train_label_pair = './data/preprocessed-experiment-lists/' \
                                #'/train_label_pair.txt'
        self.train_label_pair = './data/preprocessed-wiki-lists/' \
                                '/train_label_pair.txt'
        self.true_labels = []
        self.false_labels = []
        self.images = []
