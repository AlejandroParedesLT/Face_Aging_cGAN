...
#flags.DEFINE_string("checkpoint_dir", './checkpoints/0_conv5_lsgan_transfer_g75_0.5f-4_a30/checkpoints_alejandro/',
flags.DEFINE_string("checkpoint_dir", './checkpoints/load_pe/',
...
def my_train():
    with tf.Graph().as_default():
        ...
        if model.load(FLAGS.checkpoint_dir, model.saver, 'acgan', 399999): # 999
            print(" [*] Load SUCCESS")
        else:
            print(" [!] Load failed...")
